...
<div id="div1">
	<h3>删除读者</h3>
	<form name="form1" action="deleteReader.do" method="post">
    	<table id="table1">
        	<tr>
            	<td width="30%">读者编号：</td>
                <td width="70%">
                <input name="reader.no" type="text"/>
                </td>
            </tr>
        	<tr>
            	<td>&nbsp;</td>
                <td><input name="submit1" type="submit" value="确定"  /><input name="" type="reset" value="重置" /></td>
            </tr>
        </table>
    </form>
</div>
