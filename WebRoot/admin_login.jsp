...
<div id="div1">
	...
	<form name="" action="login.do" method="post">
    	<table id="table1">
        	<tr>
            	<td width="30%">用户名：</td>
                <td width="70%"><input name="user.name" type="text"  class="w160" /></td>
            </tr>
        	<tr>
            	<td width="30%">密码：</td>
                <td width="70%"><input name="user.pwd" type="password"  class="w160"/>&nbsp;${msg}</td>
            </tr>
        	<tr>
            	<td>&nbsp;</td>
                <td><input name="" type="submit" value="登录"/><input name="" type="reset" value="重置" /></td>
            </tr>
        </table>
    </form>
</div>
