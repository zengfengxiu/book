...
<div id="div1">
	<h3>添加图书</h3>
	<form name="" action="addBook.do" method="post">
    	<table id="table1">
        	<tr>
            	<td width="15%">图书编号：</td>
                <td width="35%"><input name="book.no" type="text" /></td>
            	<td width="15%">图书名称：</td>
                <td width="35%"><input name="book.name" type="text" /></td>
            </tr>
        	<tr>
            	<td>图书类型：</td>
                <td>
        	...
        	<tr>
            	<td>价格：</td>
                <td><input name="book.price" type="text" /></td>
            	<td>数量：</td>
                <td><input name="book.quantity" type="text" /></td>
            </tr>
        	<tr>
            	<td>出版社：</td>
                <td><input name="book.publisher" type="text" /></td>
            	<td>备注：</td>
                <td><input name="book.remark" type="text" /></td>
            </tr>
        	<tr>
            	<td>&nbsp;</td>
