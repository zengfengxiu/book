...
<div id="div1">
	<h3>添加读者</h3>
	<form name="" action="addReader.do" method="post">
    	<table id="table1">
        	<tr>
            	<td width="30%">读者编号：</td>
                <td width="70%"><input name="reader.no" type="text" /></td>
            </tr>
        	<tr>
            	<td>读者姓名：</td>
                <td><input name="reader.name" type="text" /></td>
            </tr>
        	<tr>
            	<td>电话：</td>
                <td><input name="reader.phone" type="text" /></td>
            </tr>
        	<tr>
            	<td>地址：</td>
                <td><input name="reader.address" type="text" /></td>
            </tr>
        	<tr>
            	<td>备注：</td>
                <td><input name="reader.remark" type="text" /></td>
            </tr>
        	<tr>
            	<td>&nbsp;</td>
